...
angular.module('koolikottApp')
    .component('dopAside', {
            ...
            controller: dopAsideController
        }
    );

dopAsideController.$inject = ['$scope', 'serverCallService', '$location', 'searchService', '$timeout', 'authenticatedUserService'];

function dopAsideController($scope, serverCallService, $location, searchService, $timeout, authenticatedUserService) {
